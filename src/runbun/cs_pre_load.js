...
calc.SPECIES[8] = structuredClone(calc.SPECIES[9])
...
calc.SPECIES[8]["Zoroark-Hisui"].bs  = { hp: 60, at: 105, df: 60, sa: 120, sd: 60, sp: 105 };
calc.SPECIES[8]["Zorua-Hisui"].bs = { hp: 35, at: 60, df: 40, sa: 85, sd: 40, sp: 70 };
calc.SPECIES[8]["Zacian"].bs = { hp: 92, at: 130, df: 115, sa: 80, sd: 115, sp: 138 };
calc.SPECIES[8]["Zamazenta"].bs = { hp: 92, at: 130, df: 115, sa: 80, sd: 115, sp: 138 };
calc.SPECIES[8]["Cresselia"].bs = { hp: 120, at: 70, df: 120, sa: 75, sd: 130, sp: 85 };
calc.SPECIES[8]["Kleavor"].bs = { hp: 70, at: 130, df: 95, sa: 45, sd: 75, sp: 85 };
...
calc.SPECIES[8]["Azumarill"].bs = {hp: 100, at: 65, df: 80, sa: 90,  sd: 80,  sp: 50};
calc.SPECIES[8]["Marill"].bs = { hp: 70, at: 20, df: 50, sa: 20, sd: 50, sp: 40 };
calc.SPECIES[8]["Diggersby"].bs = { hp: 85, at: 71, df: 77, sa: 50, sd: 77, sp: 78 };
//correct the wrong moves
MOVES_BY_ID[8]["covet"].type = "Fairy";
MOVES_BY_ID[8]["absorb"].basePower = 40;
